...
class Logic:
    ...
    def upgrade(self, currency_var, machine_number, label=None):
        ...
        if machines[machine_number] < 4:
            if player_money >= (100 * int(machine_number)**2) * machines[machine_number]**2:
                player_money -= (100 * int(machine_number)**2) * machines[machine_number]**2
...
class GUI:
    ...
    def create_machine1_frame(self):
        ...
        Label(frame.machine1, font=FONT_DEFAULT, text='Max:$20', background='pink', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
        ...
        Button(frame.machine1, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "1", chances_lbl)).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine2_frame(self):
        ...
        Label(frame.machine2, font=FONT_DEFAULT, text='Max:$1000', background='blue', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
    ...
    def create_machine3_frame(self):
        ...
        Label(frame.machine3, font=FONT_DEFAULT, text='Max:$11000', background='green', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
    ...
    def create_machine4_frame(self):
        ...
        Label(frame.machine4, font=FONT_DEFAULT, text='Max:$250000', background='red', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
