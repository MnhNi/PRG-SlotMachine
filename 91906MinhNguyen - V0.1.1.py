...
class GUI:
    ...
    def create_machine1_frame(self):
        ...
        frame.top_frame.rowconfigure(0)
        frame.top_frame.columnconfigure(2)
        ...
        Button(frame, text='>', bg='white', font=FONT_HEADING, command=lambda: self.show_frame('Machine2')).grid(row=1,column=6, padx=0, pady=10, sticky='nsew')
