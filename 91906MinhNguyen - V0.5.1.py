...
class GUI:
    ...
    def create_machine1_frame(self):
        ...
        self.currency_lbl = Label(frame, font=FONT_DEFAULT, text=player_money)
        self.currency_lbl.grid(row=1,column=4,padx=10,pady=10,sticky='nsw')
        ...
        Button(frame.machine1, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_lbl, "1")).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine2_frame(self):
        ...
        self.roll_button2 = Button(frame.machine2, text='Roll', bg='white', font=FONT_DEFAULT, command=lambda: self.logic.roll(self.machine2_entry.get(), self.currency_lbl, "2", slot1_2, slot2_2, slot3_2, self.roll_button2))
        self.roll_button2.grid(row=3,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine2, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_lbl, "2")).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine3_frame(self):
        ...
        self.roll_button3 = Button(frame.machine3, text='Roll', bg='white', font=FONT_DEFAULT, command=lambda: self.logic.roll(self.machine3_entry.get(), self.currency_lbl, "3", slot1_3, slot2_3, slot3_3, self.roll_button3))
        self.roll_button3.grid(row=3,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine3, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_lbl, "3")).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine4_frame(self):
        ...
        slot1_4 = Label(frame.machine4, font=FONT_DEFAULT, text='')
        slot1_4.grid(row=1, column=0, padx=10,pady=10, sticky='nsew')
        slot2_4 = Label(frame.machine4, font=FONT_DEFAULT, text='')
        slot2_4.grid(row=1, column=1, padx=10, pady=10, sticky='nsew')
        slot3_4 = Label(frame.machine4, font=FONT_DEFAULT, text='')
        ...
        self.roll_button4 = Button(frame.machine4, text='Roll', bg='white', font=FONT_DEFAULT, command=lambda: self.logic.roll(self.machine4_entry.get(), self.currency_lbl, "4", slot1_4, slot2_4, slot3_4, self.roll_button4))
        self.roll_button4.grid(row=3,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine4, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_lbl, "4")).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
