...
class Logic:
    ...
    def set_status_variables(self, day_var, turn_var):
    ...
    def upgrade(self, currency_var, machine_number, label=None):
        global player_money
        global machines
        player_money = float(player_money)
        if machines[machine_number] < 4:
            if player_money >= (100 * int(machine_number)**2) * machines[machine_number]**3:
                player_money -= (100 * int(machine_number)**2) * machines[machine_number]**3
                ...
                if label is not None:
                    self.odd_lbl_config(label, machine_number)
            else:
                messagebox.showwarning('POOR XD', 'You don\'t have enough money!')
        else:
    ...
    def machine_level(self, label, machine_number):
        global machines
        string = f"Level: {machines[machine_number]}"
...
class GUI:
    def __init__(self, root):
        ...
        self.logic.set_status_variables(self.day_var, self.turn_var)
    ...
    def create_machine1_frame(self):
        ...
        Label(frame.top_frame, font=FONT_DEFAULT, textvariable=self.day_var, width=12, anchor='e').grid(row=0,column=2,padx=10,pady=10,sticky='nsew')
        ...
        # Entry (Enter money)
        Label(frame.machine1, font=FONT_DEFAULT, text=f"Min:${money_range['1']['minimum']}\nMax:${money_range['1']['maximum']}", background='pink', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
        ...
        Label(frame, font=FONT_DEFAULT, textvariable=self.turn_var, width=12, anchor='e').grid(row=1,column=2,padx=10,pady=10,sticky='nsw')

        Label(frame, font=FONT_DEFAULT, text='Money:').grid(row=1,column=3,padx=10,pady=10,sticky='nsew')
        Label(frame, font=FONT_DEFAULT, textvariable=self.currency_var, width=12, anchor='e').grid(row=1,column=4,padx=10,pady=10,sticky='nsw')
        ...
        self.roll_button1.grid(row=3,column=2, padx=10, pady=10, sticky='nsew')
            # Upgrade
        Button(frame.machine1, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "1", chances_lbl)).grid(row=4,column=1, padx=10, pady=10, sticky='nsew')
        Label(frame.machine1, font=FONT_DEFAULT, text=f"Level{str(machines["1"])}").grid(row=4,column=2, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine2_frame(self):
        ...
        Label(frame.top_frame, font=FONT_DEFAULT, text='Day:').grid(row=0,column=1,padx=(50, 0),pady=10,sticky='nsew')
        Label(frame.top_frame, font=FONT_DEFAULT, textvariable=self.day_var).grid(row=0,column=2,padx=10,pady=10,sticky='nsew')

        Label(frame, font=FONT_DEFAULT, text='Turn:').grid(row=1,column=1,padx=10,pady=10,sticky='nsew')
        Label(frame, font=FONT_DEFAULT, textvariable=self.turn_var).grid(row=1,column=2,padx=10,pady=10,sticky='nsw')
        ...
        Label(frame.machine2, font=FONT_DEFAULT, text=f"Min:${money_range['2']['minimum']}\nMax:${money_range['2']['maximum']}", background='blue', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
        ...
        Button(frame.machine2, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "2", chances_lbl)).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine3_frame(self):
        ...
        Label(frame.machine3, font=FONT_DEFAULT, text=f"Min:${money_range['3']['minimum']}\nMax:${money_range['3']['maximum']}", background='green', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
        ...
        Button(frame.machine3, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "3", chances_lbl)).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine4_frame(self):
        ...
        Label(frame.machine4, font=FONT_DEFAULT, text=f"Min:${money_range['4']['minimum']}\nMax:${money_range['4']['maximum']}", background='red', width=12, anchor='center').grid(row=3, column=0, sticky='nsew')
        ...
        Button(frame.machine4, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "4", chances_lbl)).grid(row=4,column=0, padx=10, pady=10, sticky='nsew')
