...
class Logic:
    ...
    def upgrade(self, currency_var, machine_number, odds_label=None, level_label=None):
        global player_money
        global machines
        player_money = float(player_money)
...
class GUI:
    ...
    def create_work_frame(self):
        ...
        Label(frame, font=FONT_MAIN_TITLE, text='Work').grid(row=0,columnspan=2,padx=10,pady=10,sticky='nsew')

        Button(frame, text='Work', bg='white', font=FONT_HEADING, command=lambda: self.logic.working(self.currency_var)).grid(row=1,columnspan=2, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine1_frame(self):
        ...
        self.roll_button1.grid(row=3,column=2, padx=10, pady=10, sticky='nsew')
            # Upgrade
        level_lbl = Label(frame.machine1, font=FONT_DEFAULT, text=f"Level: {machines['1']}", background='#f3a8ff')
        level_lbl.grid(row=4,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine1, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "1", chances_lbl, level_lbl)).grid(row=4,column=1, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine2_frame(self):
        ...
        level_lbl = Label(frame.machine2, font=FONT_DEFAULT, text=f"Level: {machines['2']}", background='#9d91fa')
        level_lbl.grid(row=4,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine2, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "2", chances_lbl, level_lbl)).grid(row=4,column=1, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine3_frame(self):
        ...
        level_lbl = Label(frame.machine3, font=FONT_DEFAULT, text=f"Level: {machines['3']}", background='#a8c7ff')
        level_lbl.grid(row=4,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine3, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "3", chances_lbl, level_lbl)).grid(row=4,column=1, padx=10, pady=10, sticky='nsew')
    ...
    def create_machine4_frame(self):
        ...
        level_lbl = Label(frame.machine4, font=FONT_DEFAULT, text=f"Level: {machines['4']}", background='#ff99b1')
        level_lbl.grid(row=4,column=2, padx=10, pady=10, sticky='nsew')
        Button(frame.machine4, text='Upgrade', bg='white', font=FONT_HEADING, command=lambda: self.logic.upgrade(self.currency_var, "4", chances_lbl, level_lbl)).grid(row=4,column=1, padx=10, pady=10, sticky='nsew')
